...
\address{
	\hspace{-0.67\textwidth}% Position of the institution logo
	\vspace{0.15\textwidth} % Position of the institution logo
	\includegraphics[width=2in]{\logo} % Include the logo of author institution
	\vskip -0.137\textheight~\\ % Position of the large header text in relation to the institution logo, increase to move down, decrease to move up
	...
	%\hspace{0.2\textwidth}\headerlinetwo\hfill \normalsize % Second line of institution name, adjust hspace if your logo is wide
        \hspace{0.975\textwidth} %position of name, increase to move left
	\makebox[0ex][r]{\textbf{\Who}}\hspace{0.01\textwidth} % Print author name and title with a little whitespace to the right
	~\\[-0.01\textheight] % Reduce the whitespace above the horizontal rule
	\hspace{0.35\textwidth}\vhrulefill{1pt} \\ % Horizontal rule, adjust hspace if your logo is wide and \vhrulefill for the thickness of the rule
